  ...
  if (c.id === "join") {
    return (
      <div className="overflow-hidden rounded-[28px] border border-zinc-100 bg-white shadow-sm">
        <div className="h-[130px] bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-sm font-semibold text-blue-700">
          Join Class
        </div>

        <div className="p-5">
          <p className="text-sm font-semibold text-zinc-900">Join Class</p>
          <p className="mt-2 text-xs text-zinc-600">
            Set up new class with location boundaries
          </p>

          <p className="mt-2 text-xs text-zinc-500">
            Join using class code or QR from your teacher
          </p>

          <button className="mt-4 w-full rounded-xl bg-[#2F52FF] py-2.5 text-xs font-semibold text-white hover:opacity-95">
            Join Class
          </button>
        </div>
      </div>
  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-zinc-100 bg-white shadow-sm">
      ...
      <div className="p-5">
        ...
        <p className="mt-1 text-xs text-teal-700">by {c.teacher}</p>
  ...
  return (
    <div className="flex min-h-screen bg-[#fbfbfb]">
      ...
      <aside className="w-[270px] border-r border-zinc-100 bg-white px-6 py-7">
        <div className="flex items-center gap-3">
          <div className="relative h-12 w-12 overflow-hidden rounded-xl bg-zinc-100 shadow-sm">
            <Image
      ...
      <main className="flex-1">
        <div className="w-full px-8 py-6">
          ...
          <div className="relative flex items-center justify-between">
            {/* Left: KIT logo */}
            <div className="flex items-center gap-3">
              <div className="relative h-12 w-20 overflow-hidden rounded-xl bg-zinc-100 shadow-sm">
                <Image
                  src="/kit-logo.png"
                  alt="KIT"
                  fill
                ...
                <div className="lg:col-span-8">
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <StatCard
                      ...
                      value={<span className="text-4xl">Join</span>}
                      sub="2 new class"
                      rightIcon={<IconPlus />}
                    />
                    <StatCard
                      ...
                      value={<span className="text-4xl">80%</span>}
                    ...
                    <StatCard
                      title="Present"
                      label="Days Present"
                      value={<span className="text-4xl">8</span>}
                  ...
                  <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <StatCard
                      ...
                      value={<span className="text-4xl">90%</span>}
                    ...
                    <StatCard
                      ...
                      value={<span className="text-4xl">85%</span>}
...
function AttendanceView() {
  ...
  return (
    <div className="space-y-6">
      {/* TOP ROW: profile (left) + map (middle) + class actions (right) */}
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        {/* Profile / Info (move to top) */}
        <div className="lg:col-span-3">
          <div className="rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-zinc-900">Vy Seoul | Student</p>
                <p className="mt-1 text-xs text-zinc-400">Batch: 13</p>
                <p className="text-xs text-zinc-400">Student ID: 37825698</p>
                <p className="text-xs text-zinc-400">Email: vyseoul@kit.edu.kh</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Map */}
        <div className="lg:col-span-4">
          <div className="relative h-[180px] overflow-hidden rounded-2xl border border-zinc-100 bg-zinc-100 shadow-sm">
          ...
          <div className="rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-2xl font-semibold text-[#E2A774]">Machine Learning</h2>
                <p className="mt-2 text-sm text-zinc-600">
                  You can clock-in only at the right time and right place.
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7">
          <div className="rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm">
            <p className="text-sm font-semibold text-zinc-900">Absence records</p>
                ...
                <tbody>
                  {records.map((r) => (
                    <tr key={r.id} className="border-t border-zinc-100">
                      <td className="py-3 pr-4 text-zinc-700">{r.date}</td>
                      <td className="py-3 pr-4 text-zinc-900 font-medium">{r.course}</td>
                      <td className="py-3 pr-4 text-zinc-700">{r.absenceReason}</td>
                      <td className="py-3 pr-4 text-zinc-700">{r.days}</td>
                      <td className="py-3">
        ...
        <div className="lg:col-span-5">
          <div className="rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm">
            <p className="text-sm font-semibold text-zinc-900">Send Absent Application</p>

            <div className="mt-4 grid grid-cols-1 gap-4">
              <div>
                <label className="text-xs font-semibold text-zinc-600">Date</label>
                <input
                  className="mt-2 h-10 w-full rounded-xl border border-zinc-200 bg-white px-4 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-[#2F52FF]/30"
                  placeholder="01 January 2022"
                />
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    className="mt-2 h-10 w-full rounded-xl border border-zinc-200 bg-white px-4 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-[#2F52FF]/30"
                    placeholder="Sick / Family / Personal"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-zinc-600">Number of Days</label>
                  <input
                    className="mt-2 h-10 w-full rounded-xl border border-zinc-200 bg-white px-4 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-[#2F52FF]/30"
                    placeholder="1"
                  />
              ...
              <div>
                ...
                <textarea
                  className="mt-2 min-h-[110px] w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-[#2F52FF]/30"
